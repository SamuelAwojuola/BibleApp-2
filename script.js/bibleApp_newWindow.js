...
function openNewWindow(){
    let newWindow;
    // window2 = open('page2_versenotes.html','winname','width=200,height=200');
    window2 = open('page2_versenotes.html','winname','location=1');
...
// function openNewWindow(){
//     let newWindow;
//     // newWindow = open('page2_versenotes.html','winname','width=200,height=200');
//     newWindow = open('page2_versenotes.html','winname','location=1');
