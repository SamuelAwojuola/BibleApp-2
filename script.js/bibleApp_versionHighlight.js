main.addEventListener('mouseover', function (e) {
    ...
    if (currentVversion) {
        ...
        function appendVersionHighlightStyle() {
            ...
            newStyleInHead.innerHTML = `.${currentVversion}{background-color: var(--verse-hover);background-color: var(--vmultiple-hover);box-shadow: 0 2px 2px 0 var(--shadow-color)`;
